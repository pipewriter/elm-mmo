...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"MouseMoved":["Mouse.Position"],"RecieveMessage":["Main.Model"],"NoOp":[]}}},"aliases":{"Main.Model":{"args":[],"type":"{ players : List Main.Player, playerId : Int }"},"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Main.Player":{"args":[],"type":"{ x : Float, y : Float, name : String, id : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
